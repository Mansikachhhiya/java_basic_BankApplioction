...
public class BankApplication {
    public static void main(String[] args) throws miniBalanceExpection, InSufficientBalance {
        ICICI_BANK mansiAccount = new ICICI_BANK("mansi",BigDecimal.valueOf(9000),BigDecimal.valueOf(5000),Account_type.SAVING);
//        mansiAccount.deposit(BigDecimal.valueOf(500));
        System.out.println("_______________________________________________________");
        HDFC_BANK deptiAccount = new HDFC_BANK("depti", BigDecimal.valueOf(5000),BigDecimal.valueOf(2000),Account_type.CURRENT);
//        deptiAccount.withdraw(BigDecimal.valueOf(200));
        ...
        mansiUPI.transfer(BigDecimal.valueOf(8000),deptiUPI);
